...
const PaymentPending: React.FC = () => {
      ...
      if (paymentId) {
        try {
          ...
          if (result.success) {
            ...
            // If payment is approved, redirect to success page
  ...
  const getPaymentTypeInfo = (type: string) => {
    switch (type) {
      case 'membership':
        return {
          title: 'Procesando Membresía',
          description: 'Estamos procesando tu pago de membresía URContent',
          icon: '⏳'
        };
      case 'collaboration':
        return {
          title: 'Procesando Pago de Colaboración',
          description: 'El pago de la colaboración está siendo procesado',
          icon: '🤝'
        };
      case 'experience':
        return {
          title: 'Procesando Reserva',
          description: 'Tu reserva de experiencia está siendo procesada',
          icon: '✨'
        };
      default:
        return {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              {paymentInfo.title} {paymentInfo.icon}
            </h1>
          ...
          {!loading && paymentDetails && (
            <Card className="p-8 mb-8 bg-gradient-to-r from-yellow-50 to-orange-50 border-yellow-200">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  ...
                  Te redirigiremos automáticamente cuando el pago sea confirmado.
                </p>
              </div>
            </div>
          </Card>
              ...
              <div className="space-y-3 text-left max-w-2xl mx-auto">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">
                    Estamos procesando tu pago con el método seleccionado
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">
                    Tu servicio será activado automáticamente al confirmar el pago
                  </p>
                </div>
              </div>
            </div>
