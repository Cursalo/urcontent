...
export type Database = {
  public: {
    Tables: {
      business_profiles: {
        Row: {
          ...
          preferred_creator_types: string[] | null
          brand_values: string[] | null
          target_audience: Json | null
          collaboration_history: number | null
          average_rating: number | null
          is_verified_business: boolean | null
          venue_type: Database["public"]["Enums"]["venue_category"] | null
          is_beauty_pass_partner: boolean | null
      ...
      collaborations: {
        Row: {
          ...
          brand_mentions_required: boolean | null
          hashtags_required: string[] | null
      ...
      conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "conversations_collaboration_id_fkey"
      ...
      creator_profiles: {
        Row: {
          ...
          min_collaboration_fee: number | null
          max_collaboration_fee: number | null
          collaboration_types: string[] | null
          preferred_brands: string[] | null
          audience_demographics: Json | null
          engagement_rate: number | null
          ur_score: number | null
          ...
          beauty_pass_member_since: string | null
          created_at: string | null
          updated_at: string | null
        }
        Insert: {
      ...
      ur_scores: {
        ...
        Relationships: [
          {
            foreignKeyName: "ur_scores_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      venues: {
        ...
        Relationships: [
          {
            foreignKeyName: "venues_business_profile_id_fkey"
      ...
      offers: {
        Row: {
          ...
          category: Database["public"]["Enums"]["venue_category"]
          original_value_ars: number
          credit_cost: number | null
          min_membership_tier: Database["public"]["Enums"]["membership_tier"] | null
      ...
      reservations: {
        Row: {
          ...
          venue_commission_ars: number | null
          created_at: string | null
          updated_at: string | null
      ...
      venue_checkins: {
        Row: {
          ...
          verified_by_venue: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "venue_checkins_reservation_id_fkey"
    ...
    Enums: {
      collaboration_status: "proposed" | "accepted" | "in_progress" | "completed" | "cancelled"
      credit_transaction_type: "earned" | "spent" | "refunded" | "expired" | "bonus"
      membership_status: "active" | "cancelled" | "suspended" | "expired"
      membership_tier: "basic" | "premium" | "vip"
      offer_type: "service" | "product" | "experience" | "event"
      reservation_status: "pending" | "confirmed" | "cancelled" | "completed" | "no_show"
      transaction_status: "pending" | "completed" | "failed" | "refunded"
      user_role: "creator" | "business" | "admin"
      venue_category: "beauty" | "wellness" | "fitness" | "restaurant" | "spa" | "salon"
