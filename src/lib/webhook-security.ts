...
export const validateWebhookPayload = (payload: any): boolean => {
  ...
  // Check required fields for MercadoPago webhooks
...
export const isAllowedWebhookIP = (clientIP: string): boolean => {
...
export const generateSecureWebhookToken = (): string => {
