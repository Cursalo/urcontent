        ...
        <div className="p-6 border-b">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <Badge variant={user.role === 'creator' ? 'default' : 'secondary'} className="text-xs mt-1">
            ...
            return (
              ...
              >
                ...
                {item.badge && item.badge > 0 && (
                  <Badge variant="destructive" className="ml-auto text-xs min-w-5 h-5 flex items-center justify-center">
      ...
      >
        <div className="flex items-center justify-around py-2">
          ...
          <Button
            ...
            className="flex flex-col items-center gap-1 p-3 text-muted-foreground hover:text-foreground"
          >
            <Menu className="h-5 w-5" />
