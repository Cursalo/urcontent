...
function CopyToClipboard(_ref) {
  var copyToClipboardText = _ref.copyToClipboardText,
    ...
    link = _ref.link;
  var _useState = React.useState(copyToClipboardText),
...
function Header(_ref) {
  ...
  }, shareData.linkFavicon !== "" && React__default.createElement("div", {
    style: {
      width: "3.2rem",
      height: "3.2rem",
      borderRadius: 6,
  ...
  }, shareData.linkTitle), React__default.createElement("span", {
    style: {
  ...
  }, shareData.linkMetaDesc), React__default.createElement("span", {
    style: {
      fontWeight: "lighter",
...
function Icon(_ref) {
  ...
  return React__default.createElement("button", {
    ...
    fill: "white",
    viewBox: viewBox
  }, path)), React__default.createElement("span", {
    style: {
      display: "block",
      marginTop: "0.3rem",
      fontSize: "0.75rem"
...
var ShareOnSocial = function ShareOnSocial(_ref) {
  ...
  var _useState = React.useState("socialShareBackdropFadeIn"),
    backdropFadeClass = _useState[0],
    setBackdropFadeClass = _useState[1];
  var _useState2 = React.useState("socialSharePopupMoveIn"),
...
exports.default = ShareOnSocial;
//# sourceMappingURL=react-share-on-social.cjs.development.js.map
