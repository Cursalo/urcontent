  ...
  const steps = [
    {
      ...
      title: t('howItWorks.steps.enterTopics.title'),
      description: t('howItWorks.steps.enterTopics.description'),
      color: "from-primary/20 to-primary/5"
    },
    {
      icon: <Cpu className="h-6 w-6 text-primary" />,
      title: t('howItWorks.steps.choosePreferences.title'),
      description: t('howItWorks.steps.choosePreferences.description'),
      color: "from-primary/30 to-primary/10"
    },
    {
      icon: <Layout className="h-6 w-6 text-primary" />,
      title: t('howItWorks.steps.chooseLanguage.title'),
      description: t('howItWorks.steps.chooseLanguage.description'),
      color: "from-primary/40 to-primary/20"
    },
    {
      icon: <CheckCircle className="h-6 w-6 text-primary" />,
      title: t('howItWorks.steps.aiMagic.title'),
      description: t('howItWorks.steps.aiMagic.description'),
