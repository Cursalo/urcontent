...
const Certificate = () => {
    ...
    toPng(pdfRef.current, { cacheBust: false })
      .then((dataUrl) => {
        ...
        toast({
          ...
          description: t('toast.downloaded.description'),
        });
        setProcessing(false);
      })
      .catch((err) => {
  ...
  return (
    <>
      <SEO
        title={t('seo.title', { courseTitle })}
        description={t('seo.description', { courseTitle })}
        keywords={t('seo.keywords', { courseTitle })}
      />
        ...
        <Card className="w-full max-w-3xl shadow-lg">
          <CardContent className="p-0">
            <div className="text-center p-8 border-b relative overflow-hidden">
              ...
              <h2 className="text-3xl font-bold mb-2 relative z-10">{t('congratulations')}</h2>
              <p className="text-muted-foreground relative z-1 capitalize">
                {t('completed', { courseTitle })}
              </p>
            </div>
            ...
            <div className="p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <Button onClick={handleDownload}>
                ...
                {processing ? t('downloading') : t('downloadCertificate')}
              </Button>
            </div>
          </CardContent>
        </Card>
