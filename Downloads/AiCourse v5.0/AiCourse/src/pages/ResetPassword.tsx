...
const ResetPassword = () => {
  ...
  const getStrengthText = () => {
    if (passwordStrength < 40) return t('resetPassword.strength.weak');
    if (passwordStrength < 80) return t('resetPassword.strength.medium');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!password || !confirmPassword) {
      setError(t('resetPassword.errors.bothFields'));
      setIsLoading(false);
      return;
    }

    if (password !== confirmPassword) {
      setError(t('resetPassword.errors.noMatch'));
      setIsLoading(false);
      return;
    }
  ...
  return (
    <>
      <SEO
        ...
        keywords={t('resetPassword.seo.keywords')}
      />
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <h1 className="mt-6 text-3xl font-bold">{t('resetPassword.title')}</h1>
          ...
          <CardContent className="pt-6">
            ...
            {success ? (
              <div className="text-center py-4 space-y-4">
                ...
                <h3 className="text-lg font-medium">{t('resetPassword.successState.title')}</h3>
                <p className="text-muted-foreground">
                  {t('resetPassword.successState.description')}
                </p>
                <p className="text-sm text-muted-foreground mt-4">
                  {t('resetPassword.successState.redirecting')}
                </p>
              </div>
            ) : (
